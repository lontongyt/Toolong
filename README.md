    ...
    <body>
		...
		<script type="text/javascript">
			...
			require(['vs/editor/editor.main'], function () {
				...
				monaco.editor.defineTheme('intensity-theme', {
					base: 'vs-dark',
					inherit: true,
					rules: [
						{ token: 'global', foreground: 'ff6187', fontStyle: "bold" },
						{ token: 'keyword', foreground: 'fb9767', fontStyle: "bold" },
						{ token: 'comment', foreground: 'fed768', fontStyle: "bold" },
						{ token: 'number', foreground: 'a8db77', fontStyle: "bold" },
				...
				document.getElementsByClassName("lines-content monaco-editor-background")[0].style.backgroundImage="url(https://upload.wikimedia.org/wikipedia/commons/7/71/Black.png)"
